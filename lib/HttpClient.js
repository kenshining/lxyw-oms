...
function HttpClient(httpObj){
	...
	this.timeout=this.httpObj['timeout']||100000000;
}
HttpClient.prototype.access=function(path,datas,type,successFun,errorFun){
	...
	post_option.headers={
        ...
        "Content-Length": contentLen*2,
        "accept":'text/html,application/xhtml+xml,application/xml,application/json;q=0.9,*/*;q=0.8',
		"accept-language":'zh-CN,zh;q=0.8,en-US;q=0.5,en;q=0.3',
		"connection":'keep-alive',
		"link-key":key
    };
	this.accessByObj(post_option,datas,successFun,errorFun,httpType);
}
HttpClient.prototype.accessByObj=function(requestObj,datas,successFun,errorFun,httpType){  
	...
	if(datas){
		console.log("content2--------"+JSON.stringify(datas));
		console.log("contentLen2--------"+JSON.stringify(datas).length);
